...
def test_get_tick_size_defaults():
    ...
    # hoga >= 1
    assert 1.11 == get_tick_size(1.111)
    assert 1.11 == get_tick_size(1.119)
    # hoga >= 0.1
    assert 0.111 == get_tick_size(0.1111)
    assert 0.111 == get_tick_size(0.1119)
    # hoga >= 0
    assert 0.0111 == get_tick_size(0.01111)
    assert 0.0111 == get_tick_size(0.01119)
